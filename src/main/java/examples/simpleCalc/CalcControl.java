...
import examples.simpleCalc.actions.CalcActionsFactory;
...
public class CalcControl {
    ...
    {
        calcActionsFactory = new CalcActionsFactory();
    }
    ...
    public int difference(final int a, final int b) {
        return calcActionsFactory.getDifference().mathAct(a, b);
    }

    public double difference(final double a, final double b) {
        return calcActionsFactory.getDifference().mathAct(a, b);
    }
