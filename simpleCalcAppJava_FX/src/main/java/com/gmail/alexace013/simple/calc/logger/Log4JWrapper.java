package com.gmail.alexace013.simple.calc.logger;
...
public class Log4JWrapper {
    ...
    private static void layout() {
        ...
        try {
            final String userDir = getProperty(USER_DIR);
            final String logPath = getPropertyParameter(LOG_4_J_WRAPPER_PROPERTIES, LOG_PATH);
